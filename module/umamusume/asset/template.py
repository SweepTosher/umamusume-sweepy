...
REF_AOHARU_SPECIAL_TRAIN = Template("special_train", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.90))
REF_AOHARU_SPECIAL_TRAIN2 = Template("special_train2", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.90))
REF_AOHARU_SPECIAL_TRAIN3 = Template("special_train3", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.90))
REF_SPIRIT_EXPLOSION = Template("spirit_explosion", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.90))
REF_SPIRIT_EXPLOSION2 = Template("spirit_explosion2", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.90))
REF_SPIRIT_EXPLOSION3 = Template("spirit_explosion3", UMAMUSUME_REF_TEMPLATE_PATH, ImageMatchConfig(match_accuracy=0.90))
